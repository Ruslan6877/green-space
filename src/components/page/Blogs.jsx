...
function Blogs() {
  return (
    <div className='container  mx-auto text-center my-10'>
        <h1 className='font-bold text-2xl leading-5'>Our Blog Posts</h1>
        <p className='font-normal text-sm leading-5'>We are an online plant shop offering a wide range of cheap and trendy plants. </p>
        <div className='flex flex-wrap justify-around text-start my-5'>
            {blog.map ((item, index) => (
                <div className='w-[260px] bg-welcome' key={index}>
