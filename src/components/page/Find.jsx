...
function Find() {
  return (
    <div className='find flex flex-wrap container  mx-auto p-3 '>
        {find.map ((item, index) => (
            <div key={index} className='w-[586px] flex items-center xl:m-0 sm:m-auto ml:m-auto ml:ml-[-50px] ml:px-7 justify-between bg-welcome'>
                <img src={item.img} className='w-[300px] xl:block lg:block sm:hidden ml:hidden' alt="img" />
                <div className='find_text xl:text-end sm:text-center ml:text-center sm:pt-3 px-2'>
